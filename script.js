...
//     // Phone number should be exactly 11 digits (PH local number)
//     if (phoneInput.value.length !== 11 || !phoneInput.value.startsWith("9")) {
//       e.preventDefault();
//       alert("Phone number must be 11 digits and start with '9'.");
//       return;
//     }
